...
public class LakeBTCOrder {
    ...
    public LakeBTCOrder(@JsonProperty("trades") BigDecimal trades, @JsonProperty("total_traded_btc") BigDecimal totalTradedBtc, @JsonProperty("total_traded_currency") BigDecimal totalTradedCurrency, @JsonProperty("currency") String currency, @JsonProperty("ppc") BigDecimal ppc) {
        this.trades = trades;
